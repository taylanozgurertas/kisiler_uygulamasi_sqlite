...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider( //bloc kullaniyoruz (cubitlerimizi verecegiz uygulamaya tanitacagiz)
      providers: [
        BlocProvider(create: (context) => KayitSayfaCubit(),), //cubitimizi tanittik daha sonra farkli cubitler ekleyecegiz
