...
class VeritabaniYardimcisi{
  ...
  static Future<Database> veritabaniErisim() async{
    String veritabaniYolu = join(await getDatabasesPath(), veritabaniAdi); //databasepathe gidip rehber.sqlite adında bir veritabanı varsa onun pathini ver

    if(await databaseExists(veritabaniYolu)){ //databaseExists metodu verilen pathe bakar var mı o veritabanı dosyası orda diye
